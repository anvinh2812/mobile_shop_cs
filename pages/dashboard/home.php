                        ...
                        <div class="slidebar">
                            ...
                            if ($categoriesResult->num_rows > 0) {
                                while ($category = $categoriesResult->fetch_assoc()) {
                                    ...
                                    echo '<a href="categories_detail.php?cname=' . urlencode($category['cname']) . '" class="slidebar__item__link">';
                                    ...
                                    while ($product = $productsResult->fetch_assoc()) {
                                        ...
                                        echo '<a href="product_detail.php?pname=' . urlencode($product['pname']) . '" class="slidebar__item__submenu__item__link">';
            ...
            <div class="row featured__phone__gutter">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="" class="featured__phone__product">';
                        echo $row['pname'];
                        echo '</a>';
                        echo '</div>';
